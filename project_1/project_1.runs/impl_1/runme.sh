...
HD_PWD='C:/Users/Asus/OneDrive/Documents/AMD Vivado Vitis Projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zync_example_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zync_example_wrapper.tcl -notrace
