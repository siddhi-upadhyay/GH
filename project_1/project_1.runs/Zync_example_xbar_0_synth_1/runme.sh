...
HD_PWD='C:/Users/Asus/OneDrive/Documents/AMD Vivado Vitis Projects/project_1/project_1.runs/Zync_example_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zync_example_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zync_example_xbar_0.tcl
